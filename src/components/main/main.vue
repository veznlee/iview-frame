...
import minLogo from '@/assets/source/logo-min.jpg'
import maxLogo from '@/assets/source/logo.jpg'
import './main.less'
export default {
  name: 'Main',
  components: {
  ...
  methods: {
    ...
    handleCloseTag(res, type, route) {
      if (type !== 'others') {
        if (type === 'all') {
          this.turnToPage(this.$appConfig.homeName)
        } else {
